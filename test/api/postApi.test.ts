...
test('postCreateTweet', async () => {
  ...
  const response = await client.post.postCreateTweet({ tweetText: `Test[${time}]` });
...
test('postCreateReplyTweet', async () => {
  ...
  const client = await getClient();
  const time = new Date().toISOString();
  const response = await client.post.postCreateTweet({
    tweetText: `Test[${time}]`,
...
test('postDeleteTweet', async () => {
  ...
  const response2 = await client.post.postDeleteTweet({ tweetId: tweetId });
...
test('postCreateRetweet', async () => {
  ...
  const client = await getClient();
  const response = await client.post.postCreateRetweet({ tweetId: '1349129669258448897' });
  expect(response.raw.response.ok).toBe(true);
});
...
test('postDeleteRetweet', async () => {
  ...
  const client = await getClient();
  const response = await client.post.postDeleteRetweet({ sourceTweetId: '1349129669258448897' });
  expect(response.raw.response.ok).toBe(true);
});
...
test('postFavoriteTweet', async () => {
  ...
  const client = await getClient();
  const response = await client.post.postFavoriteTweet({ tweetId: '1349129669258448897' });
  expect(response.raw.response.ok).toBe(true);
});
...
test('postUnfavoriteTweet', async () => {
  ...
  const client = await getClient();
  const response = await client.post.postUnfavoriteTweet({ tweetId: '1349129669258448897' });
  expect(response.raw.response.ok).toBe(true);
});
