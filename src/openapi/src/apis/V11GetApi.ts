...
import {
    LiveVideoStreamStatusResponseFromJSON,
    LiveVideoStreamStatusResponseToJSON,
} from '../models/index';
...
export interface GetLiveVideoStreamStatusRequest {
    mediaKey: string;
    client: string;
...
export class V11GetApi extends runtime.BaseAPI {
     ...
     */
    async getLiveVideoStreamStatusRequestOpts(requestParameters: GetLiveVideoStreamStatusRequest): Promise<runtime.RequestOpts> {
        if (requestParameters['mediaKey'] == null) {
            throw new runtime.RequiredError(
                'mediaKey',
                'Required parameter "mediaKey" was null or undefined when calling getLiveVideoStreamStatus().'
            );
        }
        ...
        if (requestParameters['client'] == null) {
            throw new runtime.RequiredError(
                'client',
                'Required parameter "client" was null or undefined when calling getLiveVideoStreamStatus().'
            );
        }

        if (requestParameters['useSyndicationGuestId'] == null) {
            throw new runtime.RequiredError(
                'useSyndicationGuestId',
                'Required parameter "useSyndicationGuestId" was null or undefined when calling getLiveVideoStreamStatus().'
            );
        }
        ...
        if (requestParameters['cookieSetHost'] == null) {
            throw new runtime.RequiredError(
                'cookieSetHost',
                'Required parameter "cookieSetHost" was null or undefined when calling getLiveVideoStreamStatus().'
            );
        }
     ...
     */
    async getLiveVideoStreamStatusRaw(requestParameters: GetLiveVideoStreamStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<LiveVideoStreamStatusResponse>> {
        const requestOptions = await this.getLiveVideoStreamStatusRequestOpts(requestParameters);
        const response = await this.request(requestOptions, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => LiveVideoStreamStatusResponseFromJSON(jsonValue));
    }

    /**
     * get live video stream status
     */
    async getLiveVideoStreamStatus(requestParameters: GetLiveVideoStreamStatusRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<LiveVideoStreamStatusResponse> {
