...
const example = {
  ...
  "responsiveWebGrokAnalysisButtonFromBackend": false,
  ...
  "responsiveWebJetfuelFrame": false,
...
} satisfies PostCreateTweetRequestFeatures
...
const exampleParsed = JSON.parse(exampleJSON) as PostCreateTweetRequestFeatures
