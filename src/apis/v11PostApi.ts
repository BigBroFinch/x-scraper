...
type PostCreateFriendshipsParam = { userId: string; extraParam?: { [key: string]: any } };
type PostDestroyFriendshipsParam = { userId: string; extraParam?: { [key: string]: any } };
...
export class V11PostApiUtils {
  ...
  async postCreateFriendships(param: PostCreateFriendshipsParam): Promise<TwitterApiUtilsResponse<undefined>> {
    const response = await this.api.postCreateFriendshipsRaw({
      includeBlockedBy: 1, includeBlocking: 1, includeCanDm: 1, includeCanMediaTag: 1,
      includeExtHasNftAvatar: 1, includeExtIsBlueVerified: 1, includeExtProfileImageShape: 1,
      includeExtVerifiedType: 1, includeFollowedBy: 1, includeMuteEdge: 1,
  ...
  async postDestroyFriendships(param: PostDestroyFriendshipsParam): Promise<TwitterApiUtilsResponse<undefined>> {
    const response = await this.api.postDestroyFriendshipsRaw({
      includeBlockedBy: 0, includeBlocking: 0, includeCanDm: 0, includeCanMediaTag: 0,
      includeExtHasNftAvatar: 0, includeExtIsBlueVerified: 0, includeExtProfileImageShape: 0,
      includeExtVerifiedType: 0, includeFollowedBy: 0, includeMuteEdge: 0,
